<footer class="mt-28 border-t border-white/10 bg-[#0c0a1f] text-gray-400">
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-10 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
            ...
            <p class="text-sm leading-relaxed text-gray-400">
                Sua coleção de filmes organizada com estilo. 
                Descubra tendências, adicione favoritos e construa 
                sua biblioteca cinematográfica pessoal.
            </p>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm">
                <li><a href="#" class="hover:text-[#8042e8] transition-colors">Início</a></li>
                <li><a href="#features" class="hover:text-[#8042e8] transition-colors">Funcionalidades</a></li>
                <li><a href="#popular" class="hover:text-[#8042e8] transition-colors">Populares</a></li>
            </ul>
        </div>
            ...
            <ul class="space-y-2 text-sm">
                <li>
                    <a href="https://www.themoviedb.org/" target="_blank"
                       class="hover:text-[#8042e8] transition-colors">
                        API TMDB
                    </a>
                </li>
        ...
        <div>
            ...
            <div class="flex gap-4">
                ...
                <a href="https://github.com/leticialencar"
                   class="bg-white/5 hover:bg-[#8042e8] transition-colors duration-200 p-3 rounded-full hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="text-white" viewBox="0 0 16 16">
                        ...
                        0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8 8 0 0 0 16 8c0-4.42-3.58-8-8-8"/>
                    </svg>
                </a>

                <a href="https://www.linkedin.com/in/maria-leticia-b667a7312/"
                   class="bg-white/5 hover:bg-[#8042e8] transition-colors duration-200 p-3 rounded-full hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="text-white" viewBox="0 0 16 16">
                ...
                <a href="mailto:maria.silvalencars@gmail.com"
                   class="bg-white/5 hover:bg-[#8042e8] transition-colors duration-200 p-3 rounded-full hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="text-white" viewBox="0 0 16 16">
    ...
    <div class="border-t border-white/10 py-6 text-center text-sm text-gray-500">
        © {{ date('Y') }} CineBox. Todos os direitos reservados.
    </div>
